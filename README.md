...
4. Нажмите кнопку Создать МЧД. В результате будет создана МЧД, связанная с текущей пользовательской карточкой доверенности.
   
5. Нажмите кнопку Подписать МЧД. Будет предложено выбрать сертификат подписи - выполнено подписание МЧД.

6. Нажмите кнопку Экспорт МЧД. На компьютер будет сохранён архив, содержащий файл МЧД в формате XML и его подпись.
