...
11. Доверенность можно подписать в ходе согласования. Отправьте Доверенность на согласование как описано в Инструкции пользователя.
    Нажмите кнопку "Подписать" в Задании. В результате сформируется СКД, затем подпишется доверенность, ПКД перейдет в статус "Подписано", а задание перейдет в статус "Завершено".
