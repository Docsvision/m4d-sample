...
9. Если планируется отправлять доверенность на регистрацию в распределённый реестр ФНС через провайдеров внешнего ЭДО необходимо выполнить соответствующие настройки.
	Для работы через Контур.Диадок выполните настройки описанные в [документации модуля ЭДО](https://help.docsvision.com/dv6/edi/6.1/admin/attorney-settings/).
	...
	Для работы через Контур.Доверенность выполните настройки описанные в [документации модуля Интеграции с реестром МЧД](https://help.docsvision.com/dv6/m4d-registry/6.1/admin/connection-settings/).
