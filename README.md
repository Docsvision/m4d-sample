...
3. Распакуйте `PowersOfAttorney\Data\PowersOfAttorneySolution.zip` и в Конструкторе web-разметок импортируйте решение "Машиночитаемая доверенность" (выберите файл Solution.xml в папке решения).
...
11. Нажмите кнопку отзыва МЧД. Демокарточка будет переходить в состояние "Отозвана".
...
12. Нажмите кнопку удаления пользовательской карточки доверенности. С пользовательской карточки доверенности также удаляется системная карточка доверенности.
...
13. Доверенность можно подписать в ходе согласования. Отправьте Доверенность на согласование как описано в Инструкции пользователя.
