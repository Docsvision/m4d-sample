...
12. Нажмите кнопку отзыва МЧД. Появится окно заявления на отзыв, после заполнения которого появится окно с возможностью подписать сформированное заявление на отзыв, затем демокарточка будет переходить в состояние "Отозвана".
